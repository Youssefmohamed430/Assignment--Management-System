        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "nvarchar(256)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Instructors_InstId",
                        column: x => x.InstId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Courses_CrsId",
                        column: x => x.CrsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseEnrollments", x => new { x.StuId, x.CrsId });
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Courses_CrsId",
                        column: x => x.CrsId,
                        principalTable: "Courses",
                        principalColumn: "CrsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Students_StuId",
                        column: x => x.StuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Submissions_Students_StuId",
                        column: x => x.StuId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_CrsId",
                table: "Assignments",
                column: "CrsId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseEnrollments_CrsId",
                table: "CourseEnrollments",
                column: "CrsId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_InstId",
                table: "Courses",
                column: "InstId");
